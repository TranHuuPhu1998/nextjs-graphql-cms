  ...
  return (
    <aside className="w-full flex flex-col items-center">
      <div className="w-full bg-white shadow flex flex-col p-6">
        ...
        <p className="pb-2">
          Lorem ipsum dolor sit amet, consectetur adipiscing elit. Maecenas mattis est eu odio sagittis tristique. Vestibulum ut finibus leo. In hac
      ...
      <div className="w-full bg-white shadow flex flex-col my-4 p-6">
        ...
        >
          <svg
            className="svg-inline--fa fa-instagram fa-w-14 mr-2"
            aria-hidden="true"
            focusable="false"
            data-prefix="fab"
            data-icon="instagram"
